...
export class ClaudeCode implements INodeType {
  description: INodeTypeDescription = {
    ...
    description: 'Use Claude Code SDK to execute AI-powered coding tasks with tool support and MCP integration',
    defaults: {
      name: 'Claude Code',
    },
      ...
      try {
        ...
        try {
          ...
          if (outputFormat === 'text') {
            ...
            const systemInit = messages.find((m) => m.type === 'system' && (m as any).subtype === 'init') as any;
            const resultMessage = messages.find((m) => m.type === 'result') as any;
